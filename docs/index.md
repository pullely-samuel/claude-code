...
- [Common workflows](common-workflows.md): Learn about common workflows with Claude Code.
- [Manage costs effectively](costs.md): Learn how to track and optimize token usage and costs when using Claude Code.
...
- [Create plugins](plugins.md): Create custom plugins to extend Claude Code with slash commands, agents, hooks, Skills, and MCP servers.
...
- [Agent Skills](skills.md): Create, manage, and share Skills to extend Claude's capabilities in Claude Code.
